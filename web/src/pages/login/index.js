...
export default function Login( {google, facebook} ) {
  return (
    <>
      <h1 className={styles['text-center']} style={{color: '#EE1C25'}}>S c h i c k e n</h1>
      <h2 className={styles['text-center']}>Đăng nhập</h2>
      <center>
        <form>
          <div className={styles.search}>
            <FontAwesomeIcon className={styles.iconSearch} icon={faUser} />
            <input className={styles['input-field']} type="text" placeholder="Tên của bạn"/>
          </div>
          <div className={styles.search}>
            <FontAwesomeIcon className={styles.iconSearch} icon={faPhone} />
            <input className={styles['input-field']} type="text" placeholder="Số điện thoại"/>
          </div>
